...
def main():
    ...
    bookbot_dispatcher.add_handler(InlineQueryHandler(bookbot.send_book))
    bookbot_dispatcher.add_handler(CommandHandler('book', bookbot.new_books, pass_args=True))
