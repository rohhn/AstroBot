...
def main():
    ...
    photobot_dispatcher.add_handler(MessageHandler(Filters.regex('@HAC_PhotoBot tell me about|@HAC_PhotoBot Tell me about'), photobot.get_dso_data, run_async=True))
