...
class BookBot():
    ...
    def send_book(self, update: Update, context: CallbackContext):
            ...
            if books:
                    ...
                    results.append(
                        InlineQueryResultArticle(
                            ...
                            input_message_content=InputTextMessageContent(
                                message_text='<a href=\'' + self.get_book_download_link(books[i]['Mirror_1'])[
                                    0] + '\'>' + books[i]['Title'] + ' by ' + books[i]['Author'] + '</a>',
                                parse_mode='HTML')
                ...
                results.append(
                    InlineQueryResultArticle(
                        ...
                        input_message_content=InputTextMessageContent(
                            message_text='<a href=\'http://libgen.rs\'>Libgen Library</a>', parse_mode='HTML',
    ...
    def new_books(self, update: Update, context: CallbackContext):
        search_text = ''
